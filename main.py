            ...
            if full_text:
                try:
                    ...
                    if extracted_data:
                        ...
                        await update.message.reply_text(
                            "⚠️ Could not extract structured info from the photo. Please fill the form manually."
                        )
                except Exception as e:
                ...
                await update.message.reply_text(
                    "⚠️ OCR service is not configured or failed. Please fill the form manually."
                )
